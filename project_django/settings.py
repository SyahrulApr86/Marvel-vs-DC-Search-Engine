...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-3@5wx%(^*zl68l(o$^m-3%cvjv0g&mom1ra=oj5f048_al57s7')
...
IMAGE_CACHE_TTL = int(os.getenv('IMAGE_CACHE_TTL', 86400))  # 24 hours default
